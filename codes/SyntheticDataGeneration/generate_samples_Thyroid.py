...
llm = ChatOpenAI(model=params["model"], openai_api_key=params["openai_key"], base_url=params["base_url"])
...
def analyze_variable_relationships(data_coreset, prompt, llm, unique_categorical_features, output_parser, TARGET,
    ...
    relationship_analysis_prompt = """Please analyze the relationships between these features and the recurrence of 
    thyroid cancer (Recurred), identifying any significant correlations or patterns that could help in predicting cancer 
    recurrence and potential interactions between features.\n\n"""
