...
def categorical_variable_encode(configs, X_train, y_train, X_test, y_test, real_data_save_dir):
    org_X_train = pd.read_csv(os.path.join(real_data_save_dir, f'X_train.csv'), index_col=None).values
    org_y_train = pd.read_csv(os.path.join(real_data_save_dir, f'y_train.csv'), index_col=None).values
    org_X_test = pd.read_csv(os.path.join(real_data_save_dir, f'X_test.csv'), index_col=None).values
    org_y_test = pd.read_csv(os.path.join(real_data_save_dir, f'y_test.csv'), index_col=None).values
...
def get_data(configs, syn_data_save_dir, real_data_save_dir):
    X_test = pd.read_csv(os.path.join(real_data_save_dir, f'X_test.csv'), index_col=None)
    y_test = pd.read_csv(os.path.join(real_data_save_dir, f'y_test.csv'), index_col=None)
    ...
    if configs['synModel'] == 'None':
        ...
        samples = pd.read_csv(os.path.join(syn_data_save_dir, f"{configs['data']}_samples.csv"), index_col=None)
...
synSamplingIndex = 0
n = 1000
for sM in [f'{DATA_NAME}_STPromptNorg']:
    configs = {
        'data': DATA_NAME,
